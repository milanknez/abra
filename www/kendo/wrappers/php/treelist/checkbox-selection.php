...
$data = $result->read('EmployeeDirectory', array('EmployeeID', 'ReportsTo', 'FirstName', 'LastName', 'Position', 'Phone'));
...
$selectable = new \Kendo\UI\TreeListColumn();
...
$treeList->addColumn($selectable, $position, $firstName, $phone)
