...
$scheduler->timezone("Etc/UTC")
        ...
        ->addView(array('type' => 'day', 'startTime' => new DateTime('2013/6/13 7:00'), 'virtual' => true),
            array('type' => 'week', 'selected' => true, 'startTime' => new DateTime('2013/6/13 7:00'), 'virtual' => true),
            array('type' => 'month', 'virtual' => true))
