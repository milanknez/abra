...
<?php
    ...
    $operatorsPerType = new \Kendo\UI\FilterOperators();
    $stringOperstors = new \Kendo\UI\FilterOperatorsString();
    $operatorsPerField = new \Kendo\UI\FilterOperators();
    $numberOperstors = new \Kendo\UI\FilterOperatorsNumber();
    $numberCustomOperator = new \Kendo\UI\FilterCustomOperator();

    $numberCustomOperator -> name("oddNumbers")
                        -> text("Odd numbers")
                        -> handler("oddNumbersHandler");

    $numberOperstors -> custom($numberCustomOperator)
                     -> gte("Greater or equal to")
                     -> lte("Less or equal to");

    $operatorsPerField -> number($numberOperstors);

    $stringOperstors -> contains("Contains")
                    -> startsWith("Starts with");

    $operatorsPerType -> string($stringOperstors);
