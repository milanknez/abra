...
$unitsInStockCount->field("UnitsInStock")
                ->aggregate("count");
$unitsPriceSum = new \Kendo\Data\DataSourceAggregateItem();
$unitsPriceSum->field("UnitPrice")
                ->aggregate("sum");

$group = new \Kendo\Data\DataSourceGroupItem();
$group->field('UnitsInStock')
      ->addAggregate($productNameCount, $unitsOnOrderAvg, $unitsInStockMin, $unitsInStockMax, $unitsInStockCount, $unitsPriceSum);
