...
$categoriesTransport = new \Kendo\Data\DataSourceTransport();

$categoriesRead = new \Kendo\Data\DataSourceTransportRead();

$categoriesRead->url('https://demos.telerik.com/kendo-ui/service/Northwind.svc/Categories');

$categoriesTransport ->read($categoriesRead);

$categories ->transport($categoriesTransport)
        ->type('odata');
