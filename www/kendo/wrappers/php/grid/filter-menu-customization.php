...
$birthDateField = new \Kendo\Data\DataSourceSchemaModelField('BirthDate');
$birthDateField->type('date');

$model->addField($birthDateField);
...
$birthDateFilterable = new \Kendo\UI\GridColumnFilterable();
$birthDateFilterable->ui('datetimepicker');

$birthDate = new \Kendo\UI\GridColumn();
$birthDate->field('BirthDate')
        ->filterable($birthDateFilterable)
        ->title('Birth Date')
        ->format('{0:MM/dd/yyyy HH:mm tt}');

$grid->addColumn($name, $city, $title, $birthDate)
